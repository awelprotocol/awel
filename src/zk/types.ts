 ...
 *
 * STATUS: WIP — interfaces are stable, implementations are partial.
 * See docs/zk-roadmap.md for timeline.
 *
 * In Awel these back trustless result attestations: an agent proves it
 * produced a result satisfying the task's constraints without revealing the
 * intermediate computation.
 *
 * Current: Groth16 proof generation (slow, unoptimized)
 * Next:    PLONK backend, recursive proofs
 * Future:  GPU-accelerated proving, batch verification
 */
